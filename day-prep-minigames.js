...
const DAY_PREP_MINI_CONFIG = {
  ...
  cutFishCake:{title:"어묵탕 · 어묵 썰기",total:4,hitTolerance:CUT_HIT_TOLERANCE.fishCake,horizontalHitTolerance:CUT_HORIZONTAL_HIT_TOLERANCE.fishCake,travelSpeed:14,horizontalLastCut:true},
  ...
  cutTofuBlock:{title:"두부김치 · 두부 썰기",ingredient:"tofu",total:6,hitTolerance:CUT_HIT_TOLERANCE.tofu,travelSpeed:10.5},
