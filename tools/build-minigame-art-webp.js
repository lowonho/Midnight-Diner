...
const FILES = [
  ...
  /* [기름 냄비 2장] 냄비 한 장과 **그 안의 기름만 따로 뽑은 한 장**입니다.
     ...
     **화면 상자(.fry-pot)는 냄비 전체가 아니라 기름 타원입니다.**
     ...
     ⚠️ 기름막만 **잘라 냅니다.** 납품본 왼쪽 위(x 77~138 · y 14~68)에 기름 원 밖으로
        삐져나온 가느다란 획이 하나 있는데, 이 장을 반투명으로 덮으면 그 획이 냄비
        쇠테를 가로지르는 실금으로 그대로 보입니다. 기름 원의 알파 자리
        [139, 69, 804x837] 만 남기면 사라지고, 덤으로 화면 상자(.fry-pot)와 그림이
        1:1 이 되어 CSS 쪽도 inset:0 한 줄로 끝납니다. */
