...
const FILES = [
  ...
  /* [기름 냄비] **화면 상자(.fry-pot)는 냄비 전체가 아니라 기름 타원입니다.**
     조각 자리(--x/--y)가 이 상자 기준 0~100 이라, 상자가 기름과 같아야
     engine-e6 의 FRY_POT_RADIUS 가 눈에 보이는 기름 안쪽과 맞습니다.
     그래서 냄비 그림은 상자 밖으로 넘겨 깝니다(css 의 .fry-pot-asset).
       기름 타원  마스터 1081x983 중 x 16.28% w 67.44% · y 13.43% h 76.40% (실측)
       화면 상자  418 x 430.6  →  냄비 그림 619.8 x 563.6  →  2배율 1240x1127 */
  { file:"E6/fix_fry_pot_oil_smooth.png", size:[1240,1127], css:".fry-pot 418x430.6 안의 기름 타원 기준 (냄비 전체 619.8x563.6)" },
