...
const sources=["game-data.js","story-data.js","story-cinematic.js","story-prop-reveal.js","story.js","save.js"]
...
assert(titleJournalStoredReaction([
  "'잘못 저장된 작은따옴표 반응'",
  "‘잘못 저장된 곡선 작은따옴표 반응’"
].join("\\r\\n"))===[
  "“잘못 저장된 작은따옴표 반응”",
...
"기존 저장에 남은 작은따옴표 손님 반응은 줄마다 큰따옴표로 되돌려야 합니다.");
