...
/* 3-1. 메뉴 양옆 전등
   ...
   [가로 위치] 창 중심(x 945) 기준으로 518 씩 벌렸습니다.
   한계는 정면 벽(x 302~1610)입니다. 폭의 절반이 27 이라 등롱은
   x 400~454 / 1436~1490 을 차지합니다 — 둘 다 "빈 벽"(창 왼쪽 307~463 ·
   창 오른쪽 1435~1605) 안에 정확히 들어갑니다.
   417/1473 → 357/1533 까지 벌렸다가 387/1503 으로 되돌렸고, 상단 HUD 우상단
   스탯 칸이 넓어지면서(왼끝 1503.3 → 1471.3) 다시 40 씩 안쪽으로 당긴 값입니다.
   ⚠️ 좌우는 늘 창 중심(945) 대칭이어야 합니다. 한쪽만 고치지 마세요.

   [HUD 와 겹치는 것은 허용] 상단 HUD 는 캔버스 밖 DOM 이라 항상 등 위에
   옵니다. 오른쪽 등은 우상단 스탯 칸(x 1471.3~)에 오른쪽 절반이 물립니다
   (왼쪽 35 정도가 보입니다 — 넓히기 전과 같은 정도입니다).
   왼쪽 등은 메뉴 카드 줄(3장 · x 560.1~1272.1)과 닿지 않습니다. */
const DECORATION_LAMPS = [
  { key:"prop_menu_lamp_left",  cx: 427, top:0, h:150 },
  { key:"prop_menu_lamp_right", cx:1463, top:0, h:150 }
];
