...
const TTEOKBOKKI_CUT_SEQUENCE=Object.freeze([
  Object.freeze({taskId:"cutTteokbokkiCabbage",ingredientId:"cabbage",assetPrefix:"tteokCabbage",displayName:"양배추",requiredPieces:6,hitTolerance:CUT_HIT_TOLERANCE.cabbage,travelSpeed:16,progressSprites:Object.freeze(Array.from({length:7},(_,index)=>`assets/minigame/E1/cabbage-${index}.png`))}),
