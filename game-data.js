...
const MENU_DATA=Object.freeze([
  ...
  {id:"yakisoba",displayName:"볶음우동",unlockDay:3,requiredPrepTasks:["sliceYakisobaCabbage","sliceYakisobaCarrot","mixYakisobaSauce"],cookware:["pan"],isImplemented:true,icon:2,ingredients:["우동면","양배추","당근","볶음우동 소스"],prep:["board"],cook:[{station:"pan",game:"stir"}],price:8200},
