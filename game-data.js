...
const PREP_TASKS=Object.freeze({
  ...
  soakUdon:{id:"soakUdon",menuId:"yakisoba",label:"우동면 불려두기",objectLabel:"우동면과 물",objectKind:"udonBowl",miniGame:"udonSoak",prepOrder:75,isImplemented:true,dayOnly:3},
  sliceYakisobaCabbage:{id:"sliceYakisobaCabbage",menuId:"yakisoba",label:"양배추 채썰기",objectLabel:"양배추와 채칼",objectKind:"cabbage",miniGame:"mandoline",dependsOn:["soakUdon"],prepOrder:80,isImplemented:true,dayOnly:3},
  ...
  coatShrimpFlour:{id:"coatShrimpFlour",menuId:"shrimpTempura",label:"밀가루 입히기",objectLabel:"밀가루 통",objectKind:"shrimpCoat",miniGame:"shrimpCoat",dependsOn:["mixYakisobaSauce"],prepOrder:110,isImplemented:true,dayOnly:3},
  coatShrimpEgg:{id:"coatShrimpEgg",menuId:"shrimpTempura",label:"계란물 입히기",objectLabel:"계란물 볼",objectKind:"shrimpEgg",miniGame:"shrimpCoat",dependsOn:["coatShrimpFlour"],prepOrder:115,isImplemented:true,dayOnly:3},
  coatShrimpBreadcrumbs:{id:"coatShrimpBreadcrumbs",menuId:"shrimpTempura",label:"빵가루 코팅",objectLabel:"빵가루 코팅대",objectKind:"breadcrumbs",miniGame:"shrimpCoat",dependsOn:["coatShrimpEgg"],prepOrder:120,isImplemented:true,dayOnly:3},
  ...
  cutTteokbokkiCabbage:{id:"cutTteokbokkiCabbage",menuId:"tteokbokki",label:"양배추 썰기",objectLabel:"떡볶이용 양배추",objectKind:"cabbage",miniGame:"tteokbokkiCut",dependsOn:["soakTteok"],prepOrder:122,day4Order:2,isImplemented:true,dayOnly:4},
  cutTteokbokkiGreenOnion:{id:"cutTteokbokkiGreenOnion",menuId:"tteokbokki",label:"대파 썰기",objectLabel:"떡볶이용 대파",objectKind:"greenOnion",miniGame:"tteokbokkiCut",dependsOn:["cutTteokbokkiCabbage"],prepOrder:123,day4Order:3,isImplemented:true,dayOnly:4},
  cutTteokbokkiFishCake:{id:"cutTteokbokkiFishCake",menuId:"tteokbokki",label:"어묵 썰기",objectLabel:"떡볶이용 어묵",objectKind:"fishCake",miniGame:"tteokbokkiCut",dependsOn:["cutTteokbokkiGreenOnion"],prepOrder:124,day4Order:4,isImplemented:true,dayOnly:4},
  mixTteokbokkiSauce:{id:"mixTteokbokkiSauce",menuId:"tteokbokki",label:"떡볶이 양념장 계량",objectLabel:"떡볶이 양념장 볼",objectKind:"sauceBowl",miniGame:"tteokbokkiSauce",dependsOn:["cutTteokbokkiFishCake"],prepOrder:125,day4Order:5,isImplemented:true,dayOnly:4},
  sliceFriesPotato:{id:"sliceFriesPotato",menuId:"fries",label:"채칼로 감자 썰기",objectLabel:"감자와 채칼",objectKind:"potato",miniGame:"potatoMandoline",dependsOn:["mixTteokbokkiSauce"],prepOrder:126,day4Order:6,isImplemented:true,dayOnly:4},
  shakeFriesStarch:{id:"shakeFriesStarch",menuId:"fries",label:"감자 전분 털기",objectLabel:"감자 바구니",objectKind:"potatoBasket",miniGame:"potatoStarch",dependsOn:["sliceFriesPotato"],prepOrder:127,day4Order:7,isImplemented:true,dayOnly:4}
});
...
const MENU_DATA=Object.freeze([
  ...
  {id:"tofu",displayName:"두부김치",unlockDay:1,requiredPrepTasks:["cutTofuBlock","cutTofuKimchi","fryTofuKimchi"],cookware:["pan","fridge"],isImplemented:true,icon:3,ingredients:["두부","김치","돼지고기"],prep:["fridge","sink","board"],openFlow:["fridge","counter"],cook:[{station:"fridge",game:"plateKimchi"}],price:8800},
  ...
  {id:"shrimpTempura",displayName:"새우튀김",unlockDay:3,requiredPrepTasks:["coatShrimpFlour","coatShrimpEgg","coatShrimpBreadcrumbs"],cookware:["fryer"],isImplemented:true,icon:null,ingredients:["새우","밀가루","계란물","빵가루"],prep:["board"],cook:[{station:"fryer",game:"fry"}],price:8600},
