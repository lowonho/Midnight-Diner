...
const STORY_SCENES = {
  "PR-01": {
    ...
    lines: [
      ...
      { speaker: "owner", text: "그럼 레시피를 알려주겠네. 바쁜 건 맞지만 다치지 않도록 천천히 해.", showGameUI: true },
      { kind: "direction", text: "사장이 앞치마를 건네고 다은은 바로 앞치마를 맨다.", showGameUI: true },
      { kind: "gameplay", text: "주방 안을 직접 이동한다. 기구에서 멀리 있을 때는 버튼을 숨기고, 가까이 가면 기구 이름과 상호작용 버튼을 표시한다.", showGameUI: true },
      { kind: "gameplay", text: "사장의 안내에 따라 두부김치를 조리한다.", showGameUI: true, cook: { dishId: "tofu", tutorial: true, resultKey: "pr01_tofu" } },
      { kind: "gameplay", text: "사장의 안내에 따라 어묵탕을 조리한다.", showGameUI: true, cook: { dishId: "oden", tutorial: true, resultKey: "pr01_oden" } },
      { kind: "gameplay", text: "사장의 안내에 따라 닭꼬치를 조리한다.", showGameUI: true, cook: { dishId: "skewer", tutorial: true, resultKey: "pr01_skewer" } },
      { kind: "gameplay", text: "사장의 안내에 따라 새우튀김을 조리한다.", showGameUI: true, cook: { dishId: "shrimpTempura", tutorial: true, resultKey: "pr01_shrimp_tempura" } },
      { kind: "gameplay", text: "사장의 안내에 따라 볶음우동을 조리한다.", showGameUI: true, cook: { dishId: "yakisoba", tutorial: true, resultKey: "pr01_yakisoba" } },
      ...
      { kind: "gameplay", text: "마지막 손님을 위해 김치전을 조리한다. 타이밍 판정은 넉넉하고 사장의 짧은 안내가 붙는다.", showGameUI: true, cook: { dishId: "kimchi", tutorial: true, resultKey: "pr01_kimchi" } },
