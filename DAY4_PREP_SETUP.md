...
3. 떡볶이 양념장 계량
4. 감자 채칼 10회
5. 감자 전분 털기 — 봉투를 잡고 좌우로 크게 흔들거나(드래그), 새우튀김 빵가루 작업과 같은 랜덤 2키 교차 입력으로 흔듭니다 (횟수는 `day4-prep-data.js` 의 `potatoStarch.requiredPresses`)
...
5. 카운터의 준비물을 왼쪽부터 상호작용해 다섯 단계를 완료합니다. 전분 털기는 봉투를 잡고 좌우로 크게 흔들거나, 화면에 랜덤으로 선택된 두 알파벳 키를 번갈아 누릅니다(둘 다 같은 한 번으로 셉니다).
